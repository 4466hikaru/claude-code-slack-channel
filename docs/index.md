...
**Operator docs:** [Inbound auto-processing](inbound-auto-processing.md) · [Executor pickup](executor-pickup-runbook.md) · [Consult pickup](consult-pickup-runbook.md) · [Multi-agent operating rules](multi-agent-operating-rules.md) · [Claude Good / More feedback](claude-good-and-more-feedback.md)
